...
%>
        ...
        <s:else>
            ...
            <span id="userid">
            <s:if test="%{op=='login'}">
                    <s:property value="%{#session.loginUser.department}"/>
            </s:if>
            <s:elseif test="%{model==null}">
                    <s:property value="%{#session.loginUser.department}"/>
            </s:elseif>
            <s:else>
                    <s:property value="model.department"/>
            </s:else>
            </span>
            </div>
            <div class="col-12-4 col-md-12 col-sm-12 col-xs-12 bk-bg-white bk-padding-top-10">
            ...
            <span id="userid">
            <s:if test="%{op=='login'}">
                    <s:property value="%{#session.loginUser.job}"/>
            </s:if>
            <s:elseif test="%{model==null}">
                    <s:property value="%{#session.loginUser.job}"/>
            </s:elseif>
        ...
        <div class="tm-body">
        <div class="tm-title">
        <h3 class="h5 text-uppercase">September 2017</h3>
        </div>
        <ol class="tm-items">
        <%--<li>--%>
        <%--<div class="tm-info">--%>
